...
const { getBalance, getCategories, test, purchaseProduct, purchaseAirtime, checkTransactionStatus, getDataPlans, purchaseData, getTVBouquet, verifyTVSC } = require('../controllers/apiController');
